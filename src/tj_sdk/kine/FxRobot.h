...
FX_BOOL FX_Robot_Init_Lmt(FX_INT32L RobotSerial, FX_DOUBLE PNVA[7][4],
                          FX_DOUBLE J67[4][3]);
FX_BOOL FX_Robot_Init_Dyna(FX_INT32L RobotSerial, Vect3 GRV, FX_DOUBLE Mass[7],
                           Vect3 MCP[7], Vect6 I[7]);
FX_BOOL FX_Robot_Init_Dyna_Set_VirTool(FX_INT32L RobotSerial, FX_DOUBLE Mass,
                                       Vect3 MCP, Vect6 I);
////////////////////////////////////////////////////////////////////////////////////////////////
...
FX_BOOL FX_Robot_PLN_MOVL(FX_INT32L RobotSerial, Vect6 Start_XYZABC,
                          ...
                          FX_DOUBLE ACC, FX_CHAR *OutPutPath);
