...
class CRobot {
  ...
  public:
    ...
    static bool OnSetChDataA(unsigned char data_ptr[256], long size_int,
                             long set_ch);
    static long OnGetChDataB(unsigned char data_ptr[256], long *ret_ch);
    static bool OnSetChDataB(unsigned char data_ptr[256], long size_int,
                             long set_ch);
    ...
    static bool OnStartGather(long targetNum, long targetID[35],
                              long recordNum);
    static bool OnStopGather();
    static bool OnSaveGatherData(char *path);
    static bool OnSaveGatherDataCSV(char *path);

    static bool OnLinkTo(FX_UCHAR ip1, FX_UCHAR ip2, FX_UCHAR ip3,
                         FX_UCHAR ip4);
    ...
    static bool OnSetForceCtrPara_A(int fcType, double fxDir[6],
    ...
    static bool OnSetForceCtrPara_B(int fcType, double fxDir[6],
                                    double fcCtrlPara[7], double fcAdjLmt);
