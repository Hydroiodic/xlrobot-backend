...
/**
 * @file Parser.h
 * @brief The file defines the base class to handle raw TCP file transfer
 * frames.
 * @author lync
 */
...
#define MAX_PARSER_BUFSIZE                                                     \
    81000 /**< Maximum byte size of a TCP frame for file transfer.*/
/**
...
class CParser {
  ...
  protected:
    ...
    long m_raw_data_start_pos; /**< Start offset of raw TCP data stream in the
                                  buffer.*/
    ...
    unsigned char *uc_len_1; /**< Pointer of hundreds place of the size of a
                                frame's context.*/
    unsigned char *uc_len_2; /**< Pointer of decade place of the size of a
                                frame's context.*/
    unsigned char *
        uc_len_3; /**< Pointer of unit place of the size of a frame's context.*/
};
