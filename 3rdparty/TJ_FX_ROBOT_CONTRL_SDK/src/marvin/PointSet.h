...
class CPointSet {
  public:
    ...
    bool OnSub(long head_size, long head_repeatnum, long tail_size,
               long tail_repeatnum);
    ...
    bool OnFindByTag(long serial, double tag, long startpos, long &ret_start,
                     long &ret_end);
    bool OnGetSubAVG(long serial, long start, long end, double &ret_avg);

    bool OnFindByTagGetAvg(long serial, double tag, long startpos,
