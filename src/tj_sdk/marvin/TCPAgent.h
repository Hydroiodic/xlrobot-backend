...
class CTCPAgent {
  public:
     ...
     */
    bool OnLinkTo(unsigned char ip1, unsigned char ip2, unsigned char ip3,
                  unsigned char ip4, unsigned long port);
    /**
  ...
  protected:
    ...
    bool m_bNetInitTag; /**< Flag to denote if the running enviroment is
                           initialized.*/
    ...
    CParser
        *m_parser; /**< Point to the object for handling TCP file protocal.*/
};
