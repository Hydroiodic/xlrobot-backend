...
long CACB::OnGetStoreNum() { return item_num; }
...
long CACB::ReadBufWithSer(unsigned char *data_ptr, long size_int,
...
long CACB::PeekBufWithSer(unsigned char *data_ptr, long size_int,
                          unsigned long &serial) {
    if (init_tag_ == false) {
        return -1;
    }
