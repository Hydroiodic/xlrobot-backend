...
void CO3Polynorm::CalPnPara(double XPara[10], double y[4],
                            double ret_PnPara[4]) {
    double d1 = y[1] - y[0];
    double d2 = y[2] - y[0];
    double d3 = y[3] - y[0];
...
bool CO3Polynorm::CalPnParaSoC(double p0_XYO1O2[4], double p1_XY[2],
                               double ret_PnPara[4]) {
    ...
    ret_PnPara[3] =
        L -
        ((ret_PnPara[0] * X0_1 + ret_PnPara[1]) * X0_1 + ret_PnPara[2]) * X0_1;
    return true;
}
